...
import me.superckl.griefbegone.MagicNumberUtil;
...
public class WorldListeners implements Listener{
	...
	public void onItemSpawn(final ItemSpawnEvent e){
		...
		final String id = Integer.toString(MagicNumberUtil.getTypeId(e.getEntity().getItemStack()));
		final String data = new StringBuilder(id).append(":").append(MagicNumberUtil.getData(e.getEntity().getItemStack().getData())).toString();
		...
		new BukkitRunnable(){
			...
			public void run() {
				...
				for(final ItemStack item:stand.getInventory().getContents()){
					final String id = Integer.toString(MagicNumberUtil.getTypeId(item));
					final String data = new StringBuilder(id).append(":").append(MagicNumberUtil.getData(item.getData())).toString();
	...
	public void onEntityExplode(final EntityExplodeEvent e){
		...
		if(type == null && e.getEntity() != null && e.getEntity().getType() != null)
